...
document.getElementById('d-theme-paper').onclick = () => setTheme('dark paper');
document.getElementById('d-theme-green').onclick = () => setTheme('dark green');
document.getElementById('d-theme-purple').onclick = () => setTheme('dark purple');
